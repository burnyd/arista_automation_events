...
#Site url https://github.com/aristanetworks/goarista
#go get github.com/aristanetworks/goarista/cmd/gnmi
#gnmi -addr base_lab_leaf1:6030 -username arista -password arista subscribe '/interfaces/interface[name=Ethernet2]/state/counters'
